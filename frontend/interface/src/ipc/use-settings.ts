...
export const useSettings = () => {
  ...
  useEffect(() => {
    ...
    // Note: Tauri backend mutation events are now handled by MutationProvider
    // This avoids duplicate event processing for nyanpasu_config events
    // Only keep DOM event as fallback for manual triggers
